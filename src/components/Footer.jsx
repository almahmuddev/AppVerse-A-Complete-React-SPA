...
const companyLinks = [
  { label: 'GitHub', href: 'https://github.com/almahmuddev', external: true },
        ...
        <div className="footer-top">
          ...
          <div>
            ...
            <div className="footer-socials">
              ...
              <a href="https://x.com/almahmuddev" className="social-btn" title="Twitter / X">𝕏</a>
              <a href="https://www.linkedin.com/in/almahmuddev/" className="social-btn" title="LinkedIn">in</a>
            </div>
          </div>
